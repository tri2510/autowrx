        ...
        <DaPopup state={[true, () => {}]} trigger={<span></span>}>
          <div className='w-[400px] min-w-[400px] block px-2 md:px-6 pt-2 pb-4 bg-da-white'>
            <DaText className='block'>
              You need to logout to perform this action. Please click the button below to logout.
            </DaText>
            <DaButton onClick={handleLogout} className='block w-full gap-2 mt-6' variant='gradient'>

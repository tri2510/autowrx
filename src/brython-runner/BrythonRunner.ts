...
class BrythonRunner {
    ...
    private addExecutionHook(exec_id: string, callbacks: {
        finalize: (s: OutputPart[]) => void
    }) {
...
${indentedCode}
            ...
            async def r${varPostfix}():
                try:
                    ...
                    window${varPostfix}.console.log("no frame", e)
                finally:
            ...
            try {
                ...
                this.iframeWindow.eval(this.iframeWindow.__BRYTHON__.python_to_js(wrappedCode))

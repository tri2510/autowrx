...
export const createModelProxy = ({model, interceptor, ...props}: CreateModelObjectOptions, prefix: string = "") => {
    const proxy: {
        [key: string]: any
    } = new Proxy({}, {
        get: (target, prop, receiver) => {
            ...
            if (finalName === "get") {
                ...
                return createModelProxy({model, interceptor, monitor: props.monitor}, fullName)
            }
        }
    })

    ...
    const Actions = {
        ...
        Next: () => {
            ...
            setTimeout(async () => {
                ...
                const [outputParts, lastLine, finished] = await runCode(prototype?.name ?? "", code, playingLine === null ? 0 : playingLine + 1)
                if (playingLine !== null) {
    ...
    return (
        <div className="flex h-full w-full bg-gray-800">
            <div className="flex flex-col relative w-full">
                ...
                <ControlActionButtons playingLine={playingLine} Actions={Actions} />
                {playingLine !== null && (
                    <div className="flex px-3 py-2 border-b border-gray-700">
                        <div className="flex w-full font-mono text-sm">
                            ...
                            <div className="flex text-gray-200 whitespace-nowrap flex-1 w-0 overflow-x-auto items-center tracking-tight scroll-gray">{code.split("\n")[playingLine]}</div>
                        </div>
                    </div>
                )}
                <Terminal

...
const CreateNewTagCategorySidenav = () => {
    ...
    return (
        <div className="flex flex-col w-full px-3 py-3 h-full">
            ...
            label="Name"
            input={
                <Input state={States.Name} />
            }/>
            <InputContainer
            label="Color"
            input={
                <ColorInput state={States.Color} />
            }/>
            <div className="mt-auto">
                <Button variant="success" className="w-fit py-1 ml-auto" onClick={createCategory} disabled={creating[0] || States.Name[0] === ""}>
                    Create
                </Button>
            </div>
        </div>

...
const TagCategoryList = () => {
    ...
    if (tag_category_id) {
        ...
        if (!selectedTagCategory) {
            ...
            return (
                <TagCategoryView tagCategory={selectedTagCategory} />
            )
        }
    }
        ...
        <div className="flex flex-col px-4 py-3 select-none">
            ...
            <div className="grid grid-cols-3 gap-5">
                ...
                {permissions.TENANT(profile).canEdit() && (
                    ...
                    className="h-full"
                    trigger={
                        <div className="flex rounded border-2 items-center border-dashed text-gray-400 hover:border-gray-300 cursor-pointer transition min px-2" style={{minHeight: 40}}>

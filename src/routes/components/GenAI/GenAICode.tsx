...
import { TbCheck, TbSelector, TbCodePlus, TbSquare, TbSquareCheck, TbCode, TbStar, TbStarFilled } from "react-icons/tb";
...
const GenAICode = ({ marketplaceAddOns, onCodeChanged }: GenAICodeProps) => {
    ...
    const ResponseDisplay = () => {
        return (
            <div className="block w-full h-full">
                <SyntaxHighlighter language="python" style={customStyle} className="flex text-xs w-full scroll-gray">
                    {genCode}
                </SyntaxHighlighter>
            </div>
        );
    ...
    const fetchAddOns = async () => {
        ...
        querySnapshot.forEach((doc) => {
            ...
            if (addOn.type === "GenAI_Python") {
                addOns.push(addOn);
            }
        });
        setAddOns(addOns);
        // console.log("Add-ons:", addOns);
        // console.log("Marketplace Add-ons:", marketplaceAddOns);
            ...
            <div className="flex flex-col w-1/2 h-full pt-3 pl-2">
                ...
                <div className="flex flex-col w-full mt-auto pt-3 select-none">
                    <Button
                        ...
                        disabled={!(genCode && genCode.length > 0)}
                        icon={TbCode}

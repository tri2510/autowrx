...
export type DataTypeNum = "uint8" | "uint16" | "uint32" | "int8" | "int16" | "int32" | "float" | "double"
...
type AnyLeafNode<Type extends LeafTypes> = LeafNodeNum<Type> | LeafNodeString<Type> | LeafNodeOther<Type> 

...
const ModelBox = ({model_view, coordinates}: ModelBoxProps) => {
    ...
    return (
        <>
            <div className="flex h-full w-full bg-gray-100 items-center justify-center text-slate-400 select-none overflow-visible relative bg-white" id="model-box">
            </div>
        </>
    )
}

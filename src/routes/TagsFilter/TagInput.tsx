...
const TagInput: FC<{
    ...
    if (!activated) {
        return (
            <div
                ...
                className="flex bg-white  rounded-full text-gray-500  text-sm items-center border-2 mr-2 mb-2 cursor-pointer border-gray-200 hover:bg-gray-200 active:bg-gray-300 transition"
            >
    ...
    const selectedTagKeys = selectedTags.map(
        (categoryAndTag) => categoryAndTag.tagCategoryId + "-/-" + categoryAndTag.tag
    );
    ...
    return (
        <div className="flex bg-white  rounded-full text-gray-500 text-sm items-center border-gray-200 border-2 mr-2 mb-2">
                                ...
                                <IoCheckmark
                                    ...
                                    onClick={() => {
                                        ...
                                        onCreate({
                                            ...
                                            tagCategoryName:
                                                tagCategories.find(
                                                    (tagCategory) => tagCategory.id === selectedTagCategoryState[0]
                                                )?.name ?? "",
                                        });
                                    }}
                                />

...
const DaItemVerticalType2: React.FC<DaItemVerticalType2Props> = ({
  ...
  return (
    <div
      className="py-2 flex flex-col w-full rounded-lg  bg-da-white space-y-1 text-da-gray-dark overflow-hidden border hover:border-da-primary-500 border-da-gray-light"

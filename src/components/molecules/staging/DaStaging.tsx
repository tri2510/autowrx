...
const DaStaging = (({onCancel, loading, onClose}: DaStagingProps) => {
    ...
    return <div className="min-w-[400px] w-[90vw] max-w-[1200px] min-h-[400px]">
        { mode == MODE_EDIT_DEFINE && <DaEditSystemStaging 
            onTargetMode={false}
            system={system}
            target={null}
        ...
        { mode == MODE_ON_TARGET && <DaEditSystemStaging
            onTargetMode={true}
            system={system}
            stageDefine={stageDefine}
            target={activeTarget}
        ...
        { mode == MODE_OVERVIEW && <div>
            <DaText variant="huge-bold">Staging</DaText>
            <div className="w-full mt-4 border rounded">
            {/* Title */}
            <div className="h-[40px] w-full bg-gradient-to-r from-da-gradient-from to-da-gradient-to rounded-t text-da-white flex">
                <div className="w-[20%] flex items-center justify-center border-r border-da-white font-bold">System</div>
                <div className="grow flex items-center justify-center border-da-white font-bold">Stages</div>
            </div>
            <div className="flex">
                <div
                    className="min-w-[100px] flex-1 flex flex-col items-center justify-center overflow-x-hidden px-1 py-1 bg-[#DADADA] rounded-s">
                    <div className="w-full h-[140px] flex items-center justify-center">
                        <img width={150} height={70} src={system.icon} alt="System"/>
                    </div>
                    <DaText variant="small-bold" className="mt-1">{system.name}</DaText>
                    <DaText variant="small" className="mt-1">{system.version}</DaText>
                    <DaButton className="my-1 w-[100px]"
                        onClick={() => {
                ...
                {targets && targets.map((target: any) => <div key={target.name} 
                    className="min-w-[100px] flex-1 flex flex-col items-center justify-center overflow-x-hidden px-1 pt-1 pb-2 border-l">
                    <div className="w-full h-[140px] flex items-center justify-center">
                        <img width={120} height={70} src={target.icon} alt={target.name}/>
                    </div>
                    <DaText variant="small-bold" className="mt-1">{target.name}</DaText>
                    <DaText variant="small" className="mt-1">{target.version}</DaText>
                    <DaButton variant="outline" className="my-1 w-[100px]"
                        onClick={() => {

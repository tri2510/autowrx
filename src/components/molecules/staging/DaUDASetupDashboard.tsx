      ...
      <div className="space-y-3">
        <div className="border border-gray-200 rounded-lg p-3">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-medium text-sm">Install UDA Agent</h3>
          </div>
          <div className="ml-9 space-y-2">
            <div className="bg-gray-50 p-2 rounded border-l-4 border-blue-500">
              <p className="text-xs font-medium mb-1">Installation Commands:</p>
              <code className="block bg-gray-800 text-white p-2 rounded text-xs overflow-x-auto whitespace-pre">
git clone https://github.com/tri2510/uda-deployment-agent.git
cd uda-deployment-agent
pip install -r config/requirements.txt
python3 src/uda_agent.py --server http://localhost:3090</code>
            </div>
          </div>
        </div>
        ...
        <div className="border border-gray-200 rounded-lg p-3">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-medium text-sm">Start KUKSA Data Broker</h3>
          </div>
          <div className="ml-9 space-y-2">
            <div className="bg-gray-50 p-2 rounded border-l-4 border-green-500">
              <p className="text-xs font-medium mb-1">Docker Commands:</p>
              <code className="block bg-gray-800 text-white p-2 rounded text-xs overflow-x-auto whitespace-pre">
docker run -d --name kuksa-databroker \
  -p 55555:55555 \
  eclipse/kuksa-databroker:latest</code>
            </div>
          </div>
        </div>
        ...
        <div className="border border-gray-200 rounded-lg p-3">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-medium text-sm">Start MQTT Broker</h3>
          </div>
          <div className="ml-9 space-y-2">
...
docker run -d --name eclipse-mosquitto \
  ...
  eclipse-mosquitto:latest</code>
        ...
        <div className="border border-gray-200 rounded-lg p-3">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h3 className="font-medium text-sm">Verify Connection</h3>
          </div>
          <div className="ml-9">
            <button
              onClick={handleAgentDiscovery}
              disabled={isConnecting}
              className="px-3 py-2 bg-orange-500 text-white rounded-md hover:bg-orange-600 disabled:opacity-50 flex items-center gap-2 text-sm"
            >
              <TbRefresh className={`w-3 h-3 ${isConnecting ? 'animate-spin' : ''}`} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="border border-gray-200 rounded-lg p-3">
          <div className="flex items-center gap-2 mb-2">
            <TbDatabase className="w-4 h-4 text-blue-500" />
            <h3 className="font-medium text-sm">KUKSA Data Broker</h3>
          </div>
          <div className="space-y-2">
  ...
  return (
    <div className="w-full max-w-4xl h-[80vh] max-h-[700px] flex flex-col">
      ...
      {/* Tab Navigation */}
      <div className="flex gap-1 mb-4 p-1 bg-gray-100 rounded-lg flex-shrink-0">
        {tabs.map((tab) => (
          <button
            key={tab.id}

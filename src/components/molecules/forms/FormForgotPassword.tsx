      ...
      {sent ? (
        <>
          <DaText className='block mt-4'>
            Reset password email sent! Please check your email and follow the instructions.
          </DaText>
        ...
        <>
          <DaText className='block mt-4'>
            Enter the email associated with your account. We will send you an email to reset your password.
          </DaText>

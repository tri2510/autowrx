            ...
            <div className="flex w-full">
                <div className="flex w-full h-full">
                    <div className="flex w-[30%] max-w-[200px] h-[40%] max-h-[250px]  rounded-lg overflow-hidden">
                        <DaImage className="aspect-square rounded-lg border border-da-gray-medium object-contain"
                            src={activeWidget.thumbnail} alt="thumbnail" />
                    </div>
                    <div className="flex flex-col w-full pl-5 h-[40%] max-h-[300px]">
                        <div className="flex w-full justify-between items-center">
                            <div className="flex flex-col w-full ">
                                <DaText variant="regular-bold" className="text-da-primary-500">{activeWidget.label}</DaText>
                                <DaText variant="regular" className="mr-1 text-da-gray-medium">{activeWidget.author[0]}</DaText>
                            </div>

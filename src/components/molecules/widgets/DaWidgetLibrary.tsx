...
import { createNewWidgetByWebStudio, convertProjectPublicLinkToEditorLink } from "@/services/webStudio.service";
...
import { loadMarketWidgets, searchWidget, loadWidgetReviews } from "@/services/widget.service";
...
const DaWidgetLibrary: FC<DaWidgetLibraryProp> = ({
    ...
    const [prototype] = useModelStore((state) => [
    ...
    return (
        ...
        >
            <div className="select-none text-da-primary-500">
                <DaText variant="sub-title" className="text-da-primary-500 mb-2">Place new widget to dashboard</DaText>
                                            ...
                                            {renderWidgets.map((widget: any, index) => (
                                                ...
                                                >
                                                    ...
                                                    <div className="px-4 py-1 truncate text-ellipsis text-da-primary-500 text-base">
                                                        <DaText variant="regular-bold">{widget.label || widget.widget}</DaText>
                            ...
                            {activeWidget && (
                                <div className="flex flex-col w-full pb-4 flex-1">
                                    ...
                                    <div className="flex flex-col pr-8 pt-1">
                                        <div className="text-da-gray-medium da-label-regular italic">Options</div>
                                        ...
                                        {activeTab === "market" && widgetReviews && widgetReviews.length > 0 && (
                                            <div className="flex flex-col w-full h-full">
                                                <div className="text-da-gray-medium text-md italic">Ratings and reviews</div>

...
const DaTooltip: React.FC<DaTooltipProps> = ({
    ...
    const finalClassName = `bg-da-gray-light text-da-gray-dark da-label-small text-center rounded p-2 absolute z-50 transition-opacity duration-200 ease-in-out transition-transform ${className} ${

          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-3 justify-center">
              ...
              <button
                ...
                className="px-6 py-2 bg-green-600 text-black rounded-md hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
              >
        ...
        <div className="border-t pt-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full px-6 py-2 bg-orange-600 text-black rounded-md hover:bg-orange-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors"
            >
        ...
        <div className="border-t pt-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <button
              ...
              className="px-4 py-2 bg-purple-600 text-black rounded-md hover:bg-purple-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors text-sm"
            >
              Load All APIs
            </button>
            ...
            <button
              ...
              className="px-4 py-2 bg-indigo-600 text-black rounded-md hover:bg-indigo-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors text-sm"
            >
              Get Speed API
            </button>
            ...
            <button
              ...
              className="px-4 py-2 bg-cyan-600 text-black rounded-md hover:bg-cyan-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors text-sm"
            >
              List VSS Versions
            </button>
          </div>
        ...
        <div className="border-t pt-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <button
              ...
              className="px-4 py-2 bg-orange-600 text-black rounded-md hover:bg-orange-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors text-sm"
            >
              Set Runtime Values
            </button>
            ...
            <button
              ...
              className="px-4 py-2 bg-amber-600 text-black rounded-md hover:bg-amber-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors text-sm"
            >
              Get Runtime Values
            </button>
            ...
            <button
              ...
              className="px-4 py-2 bg-red-600 text-black rounded-md hover:bg-red-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors text-sm"
            >
              Replace All APIs
            </button>
          </div>

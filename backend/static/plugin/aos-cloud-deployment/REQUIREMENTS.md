...
- **Standard Plugin Sample**: `/backend/static/plugin/sample-tsx`
- **Docker/Service Reference**: `/backend/static/plugin/vehicle-edge-runtime`
- **AOS Build Definition**: `/home/htr1hc/01_PJNE/16_epam_digitalauto_aos/aos-edge-toolchain`
...
| Location | `backend/static/plugin/aos-cloud-deployment` |
| Branch | `feature/aos-deployment-plugin` |
...
Based on `/home/htr1hc/01_PJNE/16_epam_digitalauto_aos/aos-edge-toolchain`:

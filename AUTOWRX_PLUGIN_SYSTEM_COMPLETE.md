...
- `docs/extension-system-overview.md` — updated architecture summary for the extension tooling.
- `docs/extension-management-guide.md` — step-by-step workflow for the new management panel and workbench.
